...
export default function LeaveModule({ 
  ...
  const [localLeaves, setLocalLeaves] = useState<LeaveRequest[]>(() => {
    return initialLeaves.length > 0 ? initialLeaves : [
      { id: "LR-101", employeeId: "EMP-002", employeeName: "Sunita Aryal", leaveType: "Leave-without-pay", startDate: "2026-07-20", endDate: "2026-07-22", status: "Pending", reason: "Family health emergencies requiring travel to Janakpur." },
      { id: "LR-102", employeeId: "EMP-001", employeeName: "Devendra Thapa", leaveType: "Annual / Home Leave", startDate: "2026-07-24", endDate: "2026-07-25", status: "Approved", reason: "Vratabandha religious ceremony at my home town.", approvedBy: "Manager Approved & HR Handshaked" }
    ];
  });
