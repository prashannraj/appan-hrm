...
import { Employee, Asset, DocumentUpload, CompensationComponent, LifecycleEvent } from "../types";
import { 
...
export default function HRISModule({ employees, assets, onAddEmployee, onRemoveEmployee, onUpdateEmployee }: HRISModuleProps) {
  // Top-Level Sub-Tabs
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-[11px] text-blue-700 leading-relaxed font-bold">
              ℹ️ SSO Active Directory configurations are securely synced. When active, all Appan HRM registration and password resets are automatically federated through {ssoConfig.provider} authentication profiles.
            </div>
          </div>
